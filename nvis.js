...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  ...
  if(t>-50) {f1=2.5; f3=10.4; } // Hobart
  if(t>-40) {f1=2.8; f3=10.3; } // Learmonth, Vic
  if(t>-36) {f1=3.1; f3=10.1; } // Canberra
  if(t>-34.5) {f1=2.7; f3=10.0; } // Camden, Sydney
  if(t>-32.5) {f1=2.7; f3=9.9; } // Perth
  if(t>-31) {f1=3.6; f3=10.2; } // Brisbane
  if(t>-23) {f1=2.8; f3=10.5; } // Townsville
  if(t>-15) {f1=2.1; f3=12.8; } // Darwin
