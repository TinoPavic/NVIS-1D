...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  var t=nvis.lat;
  var f1=2.0, f3=4.7;          // Mawson Station, Antarctica   
  if(t>-50) {f1=2.3; f3=5.9; } // Hobart
  if(t>-40) {f1=2.3; f3=6.0; } // Vic Mid CBR and Hobart
  if(t>-36) {f1=2.4; f3=6.2; } // Canberra
  if(t>-34.5) {f1=2.5; f3=6.3; } // Camden, Sydney
  if(t>-32.5) {f1=2.5; f3=6.3; } // Perth
  if(t>-31) {f1=2.6; f3=6.4; } // Brisbane
  if(t>-23) {f1=2.1; f3=6.5; } // Townsville
  if(t>-15) {f1=2.1; f3=7.8; } // Darwin
  f2 = (f1+f3)/2;// adjust f2
  // Mix with prediction
  var ye=2021, mo=7, da=20;   // date when Ionosonde adjusted  
