...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  ...
  if(t>-50) {f1=2.9; f3=10; } // Hobart
  if(t>-40) {f1=2.8; f3=11.1; } // Learmonth, Vic
  if(t>-36) {f1=3.7; f3=10.1; } // Canberra
  if(t>-34.5) {f1=3.0; f3=10.4; } // Camden, Sydney
  if(t>-32.5) {f1=2.9; f3=10.5; } // Perth
  if(t>-31) {f1=4.0; f3=10.5; } // Brisbane
  if(t>-23) {f1=2.5; f3=11.5; } // Townsville
  if(t>-15) {f1=2.3; f3=13.3; } // Darwin
  f2 = (f1+f3)/2;// adjust f2
  // Mix with prediction
  var ye=2022, mo=5, da=20;   // date when Ionosonde adjusted  
