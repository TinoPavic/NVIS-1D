...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  var t=nvis.lat;
  var f1=2.9, f3=8.4;          // Mawson Station, Antarctica   
  if(t>-50) {f1=3.4; f3=7.7; } // Hobart
  if(t>-40) {f1=3.7; f3=10.8; } // Learmonth, Vic
  if(t>-36) {f1=3.4; f3=9.2; } // Canberra
  if(t>-34.5) {f1=3.5; f3=9.3; } // Camden, Sydney
  if(t>-32.5) {f1=3.6; f3=9.2; } // Perth
  if(t>-31) {f1=4.2; f3=11.2; } // Brisbane
  if(t>-23) {f1=3.5; f3=11.2; } // Townsville
  if(t>-15) {f1=4.8; f3=14.2; } // Darwin
