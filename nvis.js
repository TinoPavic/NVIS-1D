...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  var t=nvis.lat;
  var f1=3.5, f3=8.2;          // Mawson Station, Antarctica   
  if(t>-50) {f1=3.2; f3=8.2; } // Hobart
  if(t>-40) {f1=4.5; f3=11.2; } // Learmonth, Vic
  if(t>-36) {f1=3.9; f3=8.8; } // Canberra
  if(t>-34.5) {f1=4.0; f3=9.1; } // Camden, Sydney
  if(t>-32.5) {f1=4.0; f3=9.2; } // Perth
  if(t>-31) {f1=4.8; f3=10.0; } // Brisbane
  if(t>-23) {f1=3.3; f3=12.2; } // Townsville
  if(t>-15) {f1=4.4; f3=13.6; } // Darwin
  f2 = (f1+f3)/2;// adjust f2
  // Mix with prediction
  var ye=2022, mo=11, da=22;   // date when Ionosonde adjusted  
