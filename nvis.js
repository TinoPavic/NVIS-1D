...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  var t=nvis.lat;
  var f1=4.1, f3=8.5;          // Mawson Station, Antarctica   
  if(t>-50) {f1=2.9; f3=8.0; } // Hobart
  if(t>-40) {f1=4.2; f3=10.8; } // Learmonth, Vic
  if(t>-36) {f1=3.9; f3=8.6; } // Canberra
  if(t>-34.5) {f1=3.7; f3=9.0; } // Camden, Sydney
  if(t>-32.5) {f1=3.6; f3=9.2; } // Perth
  if(t>-31) {f1=4.4; f3=10.0; } // Brisbane
  if(t>-23) {f1=4.2; f3=11.8; } // Townsville
  if(t>-15) {f1=4.8; f3=12.6; } // Darwin
  f2 = (f1+f3)/2;// adjust f2
  // Mix with prediction
  var ye=2022, mo=12, da=9;   // date when Ionosonde adjusted  
